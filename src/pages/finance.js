                    ...
                    <ul className="finance-video-list">
                        ...
                        <li className="video video3">
                            ...
                            <iframe
                                ...
                                srcDoc="<style>*{padding:0;margin:0;overflow:hidden}html,body{height:100%}img,span{position:absolute;width:100%;top:0;bottom:0;margin:auto}span{height:1.5em;text-align:center;font:48px/1.5 sans-serif;color:#0A2F58;opacity:0.9;text-shadow:0 0 0.5em black}</style><a href=https://www.youtube.com/embed/bQBL1yIftlc?autoplay=1><img src=https://img.youtube.com/vi/bQBL1yIftlc/hqdefault.jpg alt=Hey Rosetta! - Fogo Sessions><span>▶</span></a>"
                                frameBorder="0"
                                allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                                allowFullScreen
